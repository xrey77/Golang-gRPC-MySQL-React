...
func (x *LoginData) Reset() {
	*x = LoginData{}
	mi := &file_proto_loginv1_login_proto_msgTypes[0]
...
func (*LoginData) Descriptor() ([]byte, []int) {
	return file_proto_loginv1_login_proto_rawDescGZIP(), []int{0}
}
...
func (x *LoginRequest) Reset() {
	*x = LoginRequest{}
	mi := &file_proto_loginv1_login_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginRequest) Descriptor() ([]byte, []int) {
	return file_proto_loginv1_login_proto_rawDescGZIP(), []int{1}
}
...
func (x *LoginResponse) Reset() {
	*x = LoginResponse{}
	mi := &file_proto_loginv1_login_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*LoginResponse) Descriptor() ([]byte, []int) {
	return file_proto_loginv1_login_proto_rawDescGZIP(), []int{2}
}
...
var File_proto_loginv1_login_proto protoreflect.FileDescriptor
...
const file_proto_loginv1_login_proto_rawDesc = "" +
	...
	"\fLoginService\x122\n" +
	"\x05Login\x12\x13.proto.LoginRequest\x1a\x14.proto.LoginResponseB)Z'golang_grpc_mysql/proto/loginv1;loginv1b\x06proto3"

var (
	file_proto_loginv1_login_proto_rawDescOnce sync.Once
	file_proto_loginv1_login_proto_rawDescData []byte
)

func file_proto_loginv1_login_proto_rawDescGZIP() []byte {
	file_proto_loginv1_login_proto_rawDescOnce.Do(func() {
		file_proto_loginv1_login_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_loginv1_login_proto_rawDesc), len(file_proto_loginv1_login_proto_rawDesc)))
	})
	return file_proto_loginv1_login_proto_rawDescData
}

var file_proto_loginv1_login_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_proto_loginv1_login_proto_goTypes = []any{
	(*LoginData)(nil),              // 0: proto.LoginData
	(*LoginRequest)(nil),           // 1: proto.LoginRequest
	(*LoginResponse)(nil),          // 2: proto.LoginResponse
	(*wrapperspb.StringValue)(nil), // 3: google.protobuf.StringValue
}
var file_proto_loginv1_login_proto_depIdxs = []int32{
...
func init() { file_proto_loginv1_login_proto_init() }
func file_proto_loginv1_login_proto_init() {
	if File_proto_loginv1_login_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_loginv1_login_proto_rawDesc), len(file_proto_loginv1_login_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_loginv1_login_proto_goTypes,
		DependencyIndexes: file_proto_loginv1_login_proto_depIdxs,
		MessageInfos:      file_proto_loginv1_login_proto_msgTypes,
	}.Build()
	File_proto_loginv1_login_proto = out.File
	file_proto_loginv1_login_proto_goTypes = nil
	file_proto_loginv1_login_proto_depIdxs = nil
}
