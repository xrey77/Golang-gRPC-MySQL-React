...
func (x *RegisterRequest) Reset() {
	*x = RegisterRequest{}
	mi := &file_proto_registerv1_register_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*RegisterRequest) Descriptor() ([]byte, []int) {
	return file_proto_registerv1_register_proto_rawDescGZIP(), []int{1}
}
...
func (x *RegisterResponse) Reset() {
	*x = RegisterResponse{}
	mi := &file_proto_registerv1_register_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
var File_proto_registerv1_register_proto protoreflect.FileDescriptor
...
var (
	file_proto_registerv1_register_proto_rawDescOnce sync.Once
	file_proto_registerv1_register_proto_rawDescData []byte
)

func file_proto_registerv1_register_proto_rawDescGZIP() []byte {
	file_proto_registerv1_register_proto_rawDescOnce.Do(func() {
		file_proto_registerv1_register_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_registerv1_register_proto_rawDesc), len(file_proto_registerv1_register_proto_rawDesc)))
	})
	return file_proto_registerv1_register_proto_rawDescData
}
...
func init() { file_proto_registerv1_register_proto_init() }
func file_proto_registerv1_register_proto_init() {
	if File_proto_registerv1_register_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_registerv1_register_proto_rawDesc), len(file_proto_registerv1_register_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
		},
		GoTypes:           file_proto_registerv1_register_proto_goTypes,
		DependencyIndexes: file_proto_registerv1_register_proto_depIdxs,
		MessageInfos:      file_proto_registerv1_register_proto_msgTypes,
	}.Build()
	File_proto_registerv1_register_proto = out.File
	file_proto_registerv1_register_proto_goTypes = nil
	file_proto_registerv1_register_proto_depIdxs = nil
}
